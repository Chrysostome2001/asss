    ...
    <v-row>
      <v-col cols="12">
        <v-card class="pa-5" flat>
          <h1 class="text-center mb-4">MANUEL D'UTILISATION</h1>
          <v-divider></v-divider>
          <v-card class="my-4 pa-4">
            <h2 class="headline mb-2">Accueil</h2>
            <p class="body-1 mb-3">
          ...
          <v-card class="my-4 pa-4">
            <h2 class="headline mb-2">Page de connexion</h2>
            <p class="body-1 mb-3">
          ...
          <v-card class="my-4 pa-4">
            <h2 class="headline mb-2">Page utilisateur</h2>
            <p class="body-1 mb-3">
          ...
          <v-card class="my-4 pa-4">
            <h2 class="headline mb-2">Vos fonctionnalités</h2>
          </v-card>

          <v-card class="my-4 pa-4">
            <h3 class="subheading mb-2">Consulter note</h3>
            <p class="body-1 mb-3">
              Vous verrez la liste des noms de vos enfant.
            </p>
            <v-img src="../assets/parent/consultation.png" contain></v-img>
            <p class="body-1 mt-3">
              Cliquez sur un nom puis sur un trimestre pour voir les notes par matière et pour ce trimestre.
            </p>
            <v-img src="../assets/parent/notes.png" contain></v-img>
          </v-card>

          <v-card class="my-4 pa-4">
            <h3 class="subheading mb-2">Compte</h3>
            <p class="body-1 mb-3">
