...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file:///home/chrysostome/asss/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///home/chrysostome/asss/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///home/chrysostome/asss/node_modules/devalue/index.js';
import destr from 'file:///home/chrysostome/asss/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file:///home/chrysostome/asss/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///home/chrysostome/asss/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file:///home/chrysostome/asss/node_modules/ohash/dist/index.mjs';
import { propsToString, renderSSRHead } from 'file:///home/chrysostome/asss/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///home/chrysostome/asss/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///home/chrysostome/asss/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///home/chrysostome/asss/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///home/chrysostome/asss/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///home/chrysostome/asss/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///home/chrysostome/asss/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file:///home/chrysostome/asss/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/chrysostome/asss/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/chrysostome/asss/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///home/chrysostome/asss/node_modules/consola/dist/index.mjs';
import { getContext } from 'file:///home/chrysostome/asss/node_modules/unctx/dist/index.mjs';
import { isVNode, version, unref } from 'file:///home/chrysostome/asss/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file:///home/chrysostome/asss/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///home/chrysostome/asss/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/home/chrysostome/asss/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/chrysostome/asss","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/chrysostome/asss/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/chrysostome/asss/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/chrysostome/asss/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/chrysostome/asss/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const rootDir = "/home/chrysostome/asss";
...
const _lazy_EN8CtQ = () => Promise.resolve().then(function () { return hello$1; });
const _lazy_IOdpFp = () => Promise.resolve().then(function () { return login_post$1; });
const _lazy_f3WDuh = () => Promise.resolve().then(function () { return test_get$1; });
const _lazy_oAJLum = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/hello', handler: _lazy_EN8CtQ, lazy: true, middleware: false, method: undefined },
  { route: '/api/login', handler: _lazy_IOdpFp, lazy: true, middleware: false, method: "post" },
  { route: '/api/test', handler: _lazy_f3WDuh, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_oAJLum, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_oAJLum, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file:///home/chrysostome/asss/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///home/chrysostome/asss/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
